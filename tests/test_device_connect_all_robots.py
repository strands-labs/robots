...
# Mock strands @tool decorator and device_connect_agent_tools for robot_mesh imports
_mesh_mock_keys = ("strands", "device_connect_agent_tools", "device_connect_agent_tools.connection")
for _key in _mesh_mock_keys:
