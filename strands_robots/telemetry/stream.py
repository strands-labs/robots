...
class TelemetryStream:
    ...
    def __init__(
        self,
        robot_id: str,
        batch_config: dict[StreamTier, BatchConfig] | None = None,
        ...
        self._buffer_first_ts: dict[StreamTier, float | None] = {tier: None for tier in StreamTier}
    ...
    @contextmanager
    def span(self, name: str, metadata: dict[str, Any] | None = None) -> Iterator[str]:
