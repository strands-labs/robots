...
class IsaacSimBackend:
    ...
    def create_world(
        ...
        if not _ensure_isaac():
            return {"status": "error", "content": [{"text": "❌ Isaac Lab not available"}]}
    ...
    def destroy(self) -> Dict[str, Any]:
        ...
        self._robot = None
        self._envs_created = False
        return {"status": "success", "content": [{"text": "🗑️ Isaac Sim world destroyed"}]}
    ...
    def add_object(
        ...
        try:
            ...
            if object_type == "box":
                ...
                return {"status": "error", "content": [{"text": f"❌ Unknown object type: {object_type}"}]}
    ...
    def add_terrain(
        ...
        try:
            ...
            if terrain_type == "flat":
                ...
                return {"status": "success", "content": [{"text": "🏔️ Flat terrain (ground plane already present)"}]}
                ...
                return {"status": "error", "content": [{"text": f"❌ Unknown terrain: {terrain_type}"}]}

        except ImportError as e:
            return {"status": "error", "content": [{"text": f"❌ Terrain requires Isaac Lab: {e}"}]}
        except Exception as e:
    ...
    def get_contact_forces(
        ...
        try:
            ...
            return {"status": "error", "content": [{"text": f"❌ Contact query failed: {e}"}]}
    ...
    def record_video(
        ...
        try:
            ...
            return {"status": "error", "content": [{"text": f"❌ Video recording requires: {e}"}]}
        except Exception as e:
            return {"status": "error", "content": [{"text": f"❌ Recording failed: {e}"}]}
