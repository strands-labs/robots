...
_LAZY_IMPORTS: dict[str, tuple[str, str]] = {
    ...
    "rover_camera": (".earthrover", "rover_camera"),
    "rover_lamp": (".earthrover", "rover_lamp"),
    "rover_move": (".earthrover", "rover_move"),
    "rover_speak": (".earthrover", "rover_speak"),
    "rover_state": (".earthrover", "rover_state"),
    "rover_stop": (".earthrover", "rover_stop"),
