    ...
    try:
        if action == "create":
            if not repo_id:
                return {
                    "status": "error",
                    "content": [{"text": "repo_id required for create"}],
                }
            ...
            try:
                ...
                if info_path.exists():
                    ...
                    return {
                        "status": "error",
                        "content": [{"text": f"Dataset not found: {repo_id}"}],
                    }
            ...
            if not repo_id:
                return {
                    "status": "error",
                    "content": [{"text": "repo_id required for recording"}],
                }
            ...
            if not active:
                return {
                    "status": "success",
                    "content": [{"text": "No active recordings"}],
                }
