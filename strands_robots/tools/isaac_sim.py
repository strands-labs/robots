...
_ISAAC_ROBOTS = {
    ...
    "franka": {
        "type": "manipulator",
        "source": "Isaac Lab Nucleus (alias panda)",
        "joints": 9,
    },
    ...
    try:
        ...
        # ── observe ───────────────────────────────────────────────
            ...
            if not obs:
                return {
                    "status": "success",
                    "content": [{"text": "📊 No observations (no robot loaded)"}],
                }
        ...
        # ── reset ─────────────────────────────────────────────────
            ...
            return {
                "status": "success",
                "content": [{"text": "🔄 World reset (recreated)"}],
            }
        ...
        # ── set_joint_pos ─────────────────────────────────────────
            ...
            if not joint_positions:
                return {
                    "status": "error",
                    "content": [{"text": "❌ joint_positions required (JSON array)"}],
                }
            ...
            if backend._robot is not None:
                ...
                return {
                    "status": "success",
                    "content": [{"text": f"🎯 Set {len(positions)} joint positions"}],
                }
        ...
        # ── get_contacts ──────────────────────────────────────────
            ...
            return {
                "status": "success",
                "content": [{"text": "📍 Contact query requires Isaac Sim runtime"}],
            }
                ...
                with open(path, "w") as f:
                    ...
                    for k, v in obs.items():
                        ...
                        if isinstance(v, np.ndarray):
                            ...
                            serializable[k] = v
                    json_mod.dump(
                        {"observations": serializable, "config": _backend_config},
                        f,
                        indent=2,
                    )
                return {
                    "status": "success",
                    "content": [{"text": f"💾 State saved to {path}"}],
                }
            return {
                "status": "error",
                "content": [{"text": "❌ No active simulation to save"}],
            }
        ...
        # ── destroy ───────────────────────────────────────────────
            ...
            return {
                "status": "success",
                "content": [{"text": "No active backend to destroy."}],
            }
        ...
        # ── export_policy ─────────────────────────────────────────
            ...
            if not input_path:
                return {
                    "status": "error",
                    "content": [{"text": "❌ input_path required (checkpoint path)"}],
                }
        ...
        # ── convert_asset ─────────────────────────────────────────
            ...
            if not input_path:
                return {
                    "status": "error",
                    "content": [{"text": "❌ input_path required"}],
                }
            ...
            if input_path.endswith((".xml", ".mjcf")):
                ...
                return {
                    "status": "error",
                    "content": [{"text": f"❌ Unknown format: {input_path}"}],
                }
